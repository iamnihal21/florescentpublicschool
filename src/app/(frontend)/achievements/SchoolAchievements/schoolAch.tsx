        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-16 md:mb-24">
              ...
              >
                {data?.subtitle || 'Celebrating our journey of excellence and groundbreaking achievements'}
              </motion.p>
            </div>
            ...
            >
              <div className="relative p-8 md:p-12 flex flex-col md:flex-row items-center gap-8 md:gap-12">
                <div className="w-24 h-24 rounded-2xl bg-gradient-to-r from-primary to-secondary flex items-center justify-center flex-shrink-0 shadow-gray-500/20">
