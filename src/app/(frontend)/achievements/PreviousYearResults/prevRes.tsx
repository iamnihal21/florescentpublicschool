        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-16 bg-card rounded-3xl p-8 border border-border">
            <h3 className="text-2xl font-bold mb-8 flex items-center gap-3">
              <Star className="text-primary" /> Performance Distribution
            </h3>
            <div className="space-y-6">
              {[
                { label: '90%+ (Distinction)', count: topPerformersCount },
                { label: 'Average Score', count: avgScore.toFixed(1) + '%' },
              ].map((item, i) => (
