...
//           >
//             Florescent Public School is committed to holistic education that balances academic
//             excellence, moral values, and lifelong learning.
//           </motion.p>
//         </div>
//       </section>
...
//             image: '/leaders/rajesh-patel.jpg',
//             message:
//               'Our vision was to establish an institution that nurtures discipline, integrity, and lifelong learning.',
//             achievements: [
//               'Founder of Florescent Public School',
//               '40+ years in educational philanthropy',
...
//             image: '/leaders/meera-shah.jpg',
//             message:
//               'We remain committed to providing a safe, inclusive, and forward-thinking environment for every child.',
//             achievements: [
//               'National Award for Educational Excellence',
//               'Led digital transformation initiatives',
//               'Community education pioneer',
//             ],
...
//             name: 'Dr. Kirit Joshi',
//             role: 'Director',
//             image: '/leaders/kirit-joshi.jpg',
//             message:
//               'Education must develop character, confidence, and curiosity alongside academic growth.',
//             achievements: [
...
//             className="bg-background border border-border/50 rounded-2xl p-8 hover:shadow-2xl transition-all"
//           >
//             {/* Image */}
...
//             {/* Message */}
//             <p className="text-muted-foreground text-center italic leading-relaxed mb-6">
//               “{leader.message}”
//             </p>
...
//           >
//             <span className="inline-block px-6 py-2 rounded-full bg-primary/10 text-primary text-sm font-semibold mb-4">
//               Our Philosophy
//             </span>
//             <h2 className="text-4xl md:text-5xl font-bold">Core Values</h2>
//             <p className="text-muted-foreground mt-4 max-w-2xl mx-auto">
//               Principles that define our educational culture
//             </p>
//           </motion.div>
